    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        valueEventListenerLastMensagemNot = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (j > 0) {
                    NotificationManager nm = (NotificationManager) GridActivity.this.getSystemService(Context.NOTIFICATION_SERVICE);
                    PendingIntent p = PendingIntent.getActivity(GridActivity.this, 0, new Intent(GridActivity.this, ChatActivity.class), 0);

                    NotificationCompat.Builder builder = new NotificationCompat.Builder(GridActivity.this);
                    ...
                    try {
                        ...
                        Ringtone toque = RingtoneManager.getRingtone(GridActivity.this, som);
                        toque.play();
                    } catch (Exception e) {

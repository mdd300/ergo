...
public class PesquisaImageClientes extends BaseAdapter {
    ...
    public PesquisaImageClientes(Context c, List<Bitmap> splittedBitmaps, List<String> splittedid, ArrayList<String> dados) {

...
public class PesquisaImageListProdRes  extends BaseAdapter {
    ...
    public PesquisaImageListProdRes(Context c, String user, String s, ArrayList<String> contatos, List<Bitmap> splittedBitmaps, List<String> splittedid, String res) {

...
public class SplittedImageListProd extends BaseAdapter {
    ...
    public SplittedImageListProd(Context c, String user, String s, ArrayList<String> contatos, List<Bitmap> splittedBitmaps, List<String> splittedid, String res) {

...
public class ResSplittedClientesImage extends BaseAdapter {
    ...
    public ResSplittedClientesImage(Context c, List<Bitmap> splittedBitmaps, List<String> splittedid, ArrayList<String> dados) {

...
public class ResPesquisaImageClientes extends BaseAdapter {
    ...
    public ResPesquisaImageClientes(Context c, List<Bitmap> splittedBitmaps, List<String> splittedid, ArrayList<String> dados) {
